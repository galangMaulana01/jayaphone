...
export default function CodJualPage(): JSX.Element {
  ...
  return (
    <div className="jp-page">
      <div>
        <h1 className="jp-page-title">COD Jual (Nego di Tempat)</h1>
        <p className="mt-1 text-sm text-jp-muted dark:text-jp-muted-dark">
          Kirim kurir untuk menjemput &amp; menegosiasikan penjualan barang yang belum tercatat di stok, langsung di lokasi customer. Untuk mengantar barang yang SUDAH terjual, gunakan &quot;Kirim via COD&quot; di Input Transaksi. Cek posisi order yang sudah dibuat di Monitoring COD.
        </p>
      </div>
