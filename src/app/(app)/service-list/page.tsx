...
export default function ServiceListPage(): JSX.Element {
  ...
  const nextDefaultStatus = (current: ServiceStatus): ServiceStatus => (current === "Antrian" ? "Proses" : current === "Proses" ? "Selesai" : current === "Menunggu_Sparepart" ? "Proses" : current);
