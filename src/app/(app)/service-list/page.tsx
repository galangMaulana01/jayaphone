...
export default function ServiceListPage(): JSX.Element {
  ...
  const { items: stokItems, loading: stokLoading, reload: reloadStok } = useApiList<Sparepart>(() => (isTeknisi ? Api.sparepart.list({}).then((r) => r.data ?? []) : Promise.resolve([])), [isTeknisi], "Gagal memuat stok sparepart");
