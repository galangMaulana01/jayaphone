...
function InfoTile({ label, value }: { label: string; value: ReactNode }): JSX.Element {
  return (
    <div className="rounded-xl bg-jp-surface-subtle p-3 dark:bg-jp-surface-subtle-dark/60">
        ...
        <div className="space-y-4 text-xs">
          {unit.foto_url && (
            <img
              src={unit.foto_url}
              alt={unit.unit_id}
              className="h-56 w-full rounded-xl object-contain bg-jp-surface-subtle dark:bg-jp-surface-subtle-dark"
            />
          )}
          ...
          <div className="border-t border-jp-border pt-3 dark:border-jp-border-dark">
            <p className="mb-2 text-[10px] uppercase tracking-widest text-jp-muted dark:text-jp-muted-dark">Spesifikasi</p>
          ...
          {isOwner && unit.harga_modal ? (
            <div className="border-t border-jp-border pt-3 dark:border-jp-border-dark">
              <p className="mb-2 text-[10px] uppercase tracking-widest text-jp-muted dark:text-jp-muted-dark">Finansial (Owner Only)</p>
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="rounded-xl border border-jp-info/20 bg-jp-info/10 p-3">
                  <p className="mb-1 text-[10px] uppercase tracking-widest text-jp-info">Harga Modal</p>
                  <p className="font-semibold text-jp-info">{formatRupiah(unit.harga_modal)}</p>
                </div>
                <div className="rounded-xl border border-jp-success/20 bg-jp-success/10 p-3">
                  <p className="mb-1 text-[10px] uppercase tracking-widest text-jp-success dark:text-jp-success-dark">Harga Jual</p>
                  <p className="font-semibold text-jp-success dark:text-jp-success-dark">{formatRupiah(unit.harga_jual)}</p>
                </div>
                <div className="rounded-xl border border-jp-warning/20 bg-jp-warning/10 p-3">
                  <p className="mb-1 text-[10px] uppercase tracking-widest text-jp-warning dark:text-jp-warning-dark">Margin</p>
                  <p className="font-semibold text-jp-warning dark:text-jp-warning-dark">{formatRupiah(margin)} ({marginPct}%)</p>
                </div>
              </div>
            </div>
          ) : null}
          ...
          {unit.keluhan ? (
            <div className="border-t border-jp-border pt-3 dark:border-jp-border-dark">
              <p className="mb-2 text-[10px] uppercase tracking-widest text-jp-muted dark:text-jp-muted-dark">Keluhan / Catatan</p>
              <p className="rounded-lg bg-jp-surface-subtle p-2 text-jp-text dark:bg-jp-surface-subtle-dark dark:text-jp-text-dark">{unit.keluhan}</p>
            </div>
          ) : null}
