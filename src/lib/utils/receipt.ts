...
/** Opens the same 80 mm printable receipt used by the legacy printStruk flow. */
export function printTransactionReceipt(transaction: Transaksi): boolean {
  ...
  printWindow.document.write(`<!doctype html><html lang="id"><head><meta charset="utf-8"/><title>Struk ${escapeHtml(transaction.trx_id)}</title><style>
